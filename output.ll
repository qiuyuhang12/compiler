...
step..:
%26 = load i32, ptr %i
%27 = load i32, ptr %endCopy
%unEq = icmp ne i32 %26, %27
br i1 %unEq, label %body.., label %end..


body..:
%28 = load ptr, ptr %Queue_int.storage
%29 = load i32, ptr %Queue_int.end
%array.idx.2 = getelementptr ptr, ptr %28, i32 %29
%array.idx.val.2 = load i32, ptr %array.idx.2
%30 = load ptr, ptr %copy
%31 = load i32, ptr %i
%array.idx.3 = getelementptr ptr, ptr %30, i32 %31
%array.idx.val.3 = load i32, ptr %array.idx.3
store i32 %array.idx.val.3, ptr %array.idx.2
%32 = load i32, ptr %Queue_int.end
%Inc = add i32 %32, 1
store i32 %Inc, ptr %Queue_int.end
%33 = load i32, ptr %i
%34 = load i32, ptr %i
%add.3 = add i32 %34, 1
%35 = load ptr, ptr %copy
%array.size.6 = call i32 @array.size(ptr %35)
...
define void @Queue_int.build(ptr %this) {
entry:
%Queue_int.this = alloca ptr
store ptr %this, ptr %Queue_int.this
%Queue_int.storage = getelementptr %class.Queue_int, ptr %this, i32 0, i32 0
%Queue_int.beg = getelementptr %class.Queue_int, ptr %this, i32 0, i32 1
%Queue_int.end = getelementptr %class.Queue_int, ptr %this, i32 0, i32 2
%36 = load i32, ptr %Queue_int.beg
store i32 0, ptr %Queue_int.beg
%37 = load i32, ptr %Queue_int.end
store i32 0, ptr %Queue_int.end
%38 = load ptr, ptr %Queue_int.storage
%39 = alloca ptr
%call.1 = call ptr @array.alloca(i32 4, i32 1, i32 1, i32 16)
store ptr %call.1, ptr %39
...
call void @_.init()
%q = alloca ptr
%40 = call ptr @malloc(i32 12)
call void @Queue_int.build(ptr %40)
store ptr %40, ptr %q
%i.1 = alloca i32
%N = alloca i32
store i32 100, ptr %N
...
%44 = load ptr, ptr %q
%45 = load i32, ptr %i.1
call void @Queue_int.push(ptr %44, i32 %45)
br label %step...1


step...1:
%46 = load i32, ptr %i.1
%pre.Inc = add i32 %46, 1
...
%47 = load ptr, ptr %q
%call.null.ret.3 = call i32 @Queue_int.size(ptr %47)
%48 = load i32, ptr %N
%unEq.1 = icmp ne i32 %call.null.ret.3, %48
...
%head = alloca i32
%52 = load ptr, ptr %q
%call.null.ret.4 = call i32 @Queue_int.top(ptr %52)
store i32 %call.null.ret.4, ptr %head
%53 = load i32, ptr %head
%54 = load i32, ptr %i.1
%unEq.2 = icmp ne i32 %53, %54
...
if.end.3:
%55 = load ptr, ptr %q
%call.null.ret.5 = call i32 @Queue_int.pop(ptr %55)
%56 = load i32, ptr %i.1
%unEq.3 = icmp ne i32 %call.null.ret.5, %56
...
if.end.4:
%57 = load ptr, ptr %q
%call.null.ret.6 = call i32 @Queue_int.size(ptr %57)
%58 = load i32, ptr %N
%59 = load i32, ptr %i.1
%sub.2 = sub i32 %58, %59
